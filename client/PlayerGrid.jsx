            ...
            <div >
              <Row>
                ...
                <Col md={3}>
                  ...
                  <Button inline onClick={((event) => { this.togglePositionFilter(event, 'K'); }).bind(this)}>Ks</Button>
                  <Button inline onClick={((event) => { this.togglePositionFilter(event, 'DST'); }).bind(this)}>DSTs</Button>
                </Col>
                <Col md={2}>
